...
public class DefenceActivity extends MvpActivity<DefencePresenter> implements DefenceView{
    ...
    private DefencePresenter defencePresenter;
    ...
    @Override
    protected DefencePresenter createPresenter() {
        defencePresenter = new DefencePresenter(this);
        return defencePresenter;
    }
