...
import com.smart.cloud.fire.mvp.defence.DefenceActivity;
...
public class DefenceListActivity extends MvpActivity<DefenceListPresenter> implements DefenceListView {
    ...
    @Override
    protected DefenceListPresenter createPresenter() {
        defenceListPresenter = new DefenceListPresenter(this);
        return defenceListPresenter;
    }
