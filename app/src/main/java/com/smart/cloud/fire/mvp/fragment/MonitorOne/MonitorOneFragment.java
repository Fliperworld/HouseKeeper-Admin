package com.smart.cloud.fire.mvp.fragment.MonitorOne;
...
import com.smart.cloud.fire.view.SwitchPopwindow;
import com.smart.cloud.fire.yoosee.FisheyeSetHandler;
...
public class MonitorOneFragment extends Fragment implements OnClickListener {
    ...
    public void regFilter() {
        ...
        filter.addAction(ConstantValues.Action.CHANGE_REMOTE_DEFENCE);
        filter.addAction(ConstantValues.Action.NEW_MONITOR);
        // 控制类传感器
        filter.addAction(ConstantValues.P2P.RET_GET_SENSOR_WORKMODE);
        filter.addAction(ConstantValues.P2P.RET_GET_LAMPSTATE);
    ...
    BroadcastReceiver br = new BroadcastReceiver() {
        ...
        public void onReceive(Context arg0, Intent intent) {
            // TODO Auto-generated method stub
            if (intent.getAction().equals(ConstantValues.P2P.RET_GET_REMOTE_DEFENCE)) {
            ...
            } else if (intent.getAction().equals(ConstantValues.Action.CHANGE_REMOTE_DEFENCE)) {
            ...
            } else if (intent.getAction().equals(ConstantValues.Action.NEW_MONITOR)) {
                ...
                if (switchPop != null) {
                    ...
                    ConstantValues.P2P.RET_GET_LAMPSTATE)) {
                int iSrcID = intent.getIntExtra("iSrcID", 0);
                byte boption = intent.getByteExtra("boption", (byte) -1);
                byte[] data = intent.getByteArrayExtra("data");
                if (boption == ConstantValues.FishBoption.MESG_GET_OK) {
