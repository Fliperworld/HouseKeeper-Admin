package com.smart.cloud.fire.mvp.fragment.MonitorTwo;
...
public class MonitorTwoFragment extends Fragment {
    ...
    BroadcastReceiver mReceiver=new BroadcastReceiver() {
        ...
        public void onReceive(Context arg0, Intent intent) {
            ...
            if(intent.getAction().equals(ConstantValues.P2P.RET_GET_SENSOR_WORKMODE)){
                //获取传感器防护计划返回
...
//	                    T.showLong(mContext, "获取错误");
            ...
            }else if(intent.getAction().equals(ConstantValues.P2P.RET_GET_LAMPSTATE)){
                if (boption == ConstantValues.FishBoption.MESG_GET_OK) {
