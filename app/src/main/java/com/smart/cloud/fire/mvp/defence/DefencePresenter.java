...
public class DefencePresenter extends BasePresenter<DefenceView>{
    ...
    public void regFilter(){
        ...
        filter.addAction(ConstantValues.P2P.RET_SET_DEFENCE_AREA);
        filter.addAction(ConstantValues.P2P.MESG_TYPE_RET_ALARM_TYPE_MOTOR_PRESET_POS);
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver(){
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.getAction().equals(ConstantValues.P2P.RET_SET_DEFENCE_AREA)){
                int result = intent.getIntExtra("result", -1);
                //学习成功
                if(result==ConstantValues.P2P_SET.DEFENCE_AREA_SET.SETTING_SUCCESS){
                    if(current_type == ConstantValues.P2P_SET.DEFENCE_AREA_SET.DEFENCE_AREA_TYPE_LEARN){
            ...
            if(intent.getAction().equals(ConstantValues.P2P.MESG_TYPE_RET_ALARM_TYPE_MOTOR_PRESET_POS)){
    ...
    public void setDefence(String yzwNumber,Contact contact,Defence defence,String clickStr){
        current_type = ConstantValues.P2P_SET.DEFENCE_AREA_SET.DEFENCE_AREA_TYPE_LEARN;
        ...
        P2PHandler.getInstance().setDefenceAreaState(contact.contactId,
                ...
                ConstantValues.P2P_SET.DEFENCE_AREA_SET.DEFENCE_AREA_TYPE_LEARN);
    }
    ...
    private void failedBind(Defence defence){
        current_type=ConstantValues.P2P_SET.DEFENCE_AREA_SET.DEFENCE_AREA_TYPE_CLEAR;
        P2PHandler.getInstance().setDefenceAreaState(contact.contactId,
                contact.contactPassword,
                defence.getArea(),
                defence.getChannel(),
                ConstantValues.P2P_SET.DEFENCE_AREA_SET.DEFENCE_AREA_TYPE_CLEAR);
    }
